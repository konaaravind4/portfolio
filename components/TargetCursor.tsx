...
const TargetCursor = ({
    ...
    useEffect(() => {
        ...
        const tickerFn = () => {
            ...
            const corners = Array.from(cornersRef.current) as HTMLDivElement[];
        ...
        const scrollHandler = () => {
            ...
            const still = el && (el === activeTarget || (el as HTMLElement).closest(targetSelector) === activeTarget);
        ...
        const enterHandler = (e: MouseEvent) => {
            ...
            const leaveHandler = () => {
                ...
                if (cornersRef.current) {
                    const cs = Array.from(cornersRef.current) as HTMLDivElement[];
